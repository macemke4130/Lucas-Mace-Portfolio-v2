    ...
    return (
        <Grid>
            <ProjectContainer>
                ...
                <LiveProjectLink href="http://www.namethatpart.com/" target="_blank" rel="noreferrer">Live Project</LiveProjectLink>
                <GitHubLink href="https://github.com/macemke4130/Bicycle-Mechanic-Game-v3" target="_blank" rel="noreferrer">GitHub Repository</GitHubLink>
            </ProjectContainer>
            <ProjectContainer>
                <ProjectTitle>Dynamic React Table</ProjectTitle>
                <ProjectImage src={dt} />
                <ProjectDescription>A scaling and dynamically loaded HTML table. JSON data is fed in, a fully dynamic comparison table is displayed. Controlled by a single prop object.</ProjectDescription>
                <TechStackTitle>Tech Stack</TechStackTitle>
                <TechStack>React</TechStack>
                <LiveProjectLink href="https://dynamic-react-table.herokuapp.com/" target="_blank" rel="noreferrer">Live Project</LiveProjectLink>
                <GitHubLink href="https://github.com/macemke4130/Dynamic-React-Table-Component" target="_blank" rel="noreferrer">GitHub Repository</GitHubLink>
            </ProjectContainer>
            <ProjectContainer>
                ...
                <LiveProjectLink href="https://dynamic-nav.herokuapp.com/" target="_blank" rel="noreferrer">Live Project</LiveProjectLink>
                <GitHubLink href="https://github.com/macemke4130/Navigation-Menu" target="_blank" rel="noreferrer">GitHub Repository</GitHubLink>
            </ProjectContainer>
            <ProjectContainer>
                ...
                <LiveProjectLink href="http://www.twincitiessendit.com" target="_blank" rel="noreferrer">Live Project</LiveProjectLink>
                <GitHubLink href="https://github.com/macemke4130/Twin-Cities-Send-It" target="_blank" rel="noreferrer">GitHub Repository</GitHubLink>
            </ProjectContainer>
            <ProjectContainer>
                ...
                <LiveProjectLink href="http://whats-still-good.herokuapp.com/" target="_blank" rel="noreferrer">Live Project</LiveProjectLink>
                <GitHubLink href="https://github.com/macemke4130/whats-good" target="_blank" rel="noreferrer">GitHub Repository</GitHubLink>
            </ProjectContainer>
            <ProjectContainer>
                ...
                <LiveProjectLink href="https://coffee-brew-profiler.herokuapp.com/" target="_blank" rel="noreferrer">Live Project</LiveProjectLink>
                <GitHubLink href="https://github.com/macemke4130/Coffee-Brew-Profiler" target="_blank" rel="noreferrer">GitHub Repository</GitHubLink>
            </ProjectContainer>
            <ProjectContainer>
                ...
                <LiveProjectLink href="https://shaving-grams.herokuapp.com/" target="_blank" rel="noreferrer">Live Project</LiveProjectLink>
                <GitHubLink href="https://github.com/macemke4130/Grams-Per-Dollar" target="_blank" rel="noreferrer">GitHub Repository</GitHubLink>
            </ProjectContainer>
            <ProjectContainer>
                ...
                <GitHubLink href="https://github.com/macemke4130?tab=repositories" target="_blank" rel="noreferrer">GitHub Repository</GitHubLink>
            </ProjectContainer>
        </Grid >
    );
}
